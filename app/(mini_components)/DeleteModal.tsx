      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="px-6 py-4 bg-gray-50 rounded-b-lg flex justify-end space-x-3 space-x-reverse">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className="px-4 py-2 cursor-pointer text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
          >
            {isLoading && (
